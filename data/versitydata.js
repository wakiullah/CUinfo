export const universityData = [
    ...
    },
    {
        ...
        items: [
            ...
            { name: "Md. Bazlur Rahman", phone: "01716105464", email: "bazlur@cu.ac.bd" },
            { name: "Dr. Pervin Akter", phone: "01783900188", email: "pervinakter@cu.ac.bd" },
            { name: "Nazmul Hossain", phone: "01787163098", email: "nazmul_soil@cu.ac.bd" },
            { name: "Md. Nurul Hamid", phone: "+8801521-222931", email: "nurulhamid.history@cu.ac.bd" },
            { name: "Nazmul HossainSayed Bin Kamal Chowdhury", phone: "01853358238", email: "Empty" },
        ],
    },
    {
        category: "Provosts",
...
export const othersInfo = [
    {
        category: "Hospital",
        items: [
            { name: "শেভরণ হাসপাতাল, হাটহাজারী", phone: "01829362632", email: "01713487946" },
            { name: "গ্রীন হেলথ হাসপাতাল,ফতেপুর ", phone: "01864491313", email: "Empty" },
            { name: "Epic Health Care", phone: "+8801984499600", email: "+8801847452925" },
            { name: "Ibn Sina Diagnostic", phone: "+8809610-009622", email: "info@ibnsinatrust.com" },
            { name: "Popular Diagnostic Center", phone: "+8809613-787810", email: "+8801938584409" },
            { name: "Parkview Hospital Ltd.", phone: "+8801976-022111", email: "+8801976-022333" },
            { name: "Bangabandhu Memorial Hospital(BBMH)", phone: "+88031-659070", email: "+88031-659070" },
            { name: "Chittagong Medical College Hospital", phone: "02-41356220", email: "cmch@hospi.dghs.gov.bd" },
            { name: "Chittagong General Hospital", phone: "+8801701248197", email: "+88031-634-111" },
            { name: "Chittagong Eye Infirmary and Training Complex", phone: " +8809643-133133", email: "ceitc@ctgeyeinfirmary.info" },
            { name: "Chittagong Dental College and Hospital", phone: "+01988844852", email: "cidch@gmail.com" },
        ],
    },
    {
        category: "Thana",
    ...
    {
        category: "Train Contact",
        items: [
            { name: "Divisional Transportation Officer/Chittagong", phone: "01711691549", email: "Empty" },
            { name: "Station Manager Chittagong", phone: "01711691550", email: "Empty" },
        ],
    },
    {
        ...
        items: [
            ...
            { name: "Hanif Enterprise- AK Khan", phone: "01752989825", email: "Empty" },
            { name: "Shohagh Paribahan- AK Khan", phone: "01926699346", email: "Empty" },
            { name: "Ena Transport- AK Khan", phone: "01886219994", email: "Empty" },
        ],
    },
    {
        category: "Courier Service",
        items: [
            { name: 'Sundarban - Campus', phone: '01531837540', email: 'Opposite of Shah Jalal Hall' },
